...
$printer -> text("la meta del dia es 12,300   \n" );
$printer -> feed(1);
...
public function ctrReportedemes() {
    ...
    foreach ($ventas as $item) {
        $printer->text(" Tr-" . $item["codigo"] . "                      L" . number_format($item["total"], 2) . "\n");
