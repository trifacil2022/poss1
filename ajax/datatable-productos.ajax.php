	...
	public function mostrarTablaProductos(){
    	...
    	$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
		  	...
		  	$imagen = "<img src='https://ellas-api.tri-facil.com/images/".$productos[$i]["imagen"]."' width='40px'>";
  			...
  			if($productos[$i]["stockmetro"] <= 10){

  				$stockmetro = "<button class='btn btn-danger'>".$productos[$i]["stockmetro"]."</button>";

  			}else if($productos[$i]["stockmetro"] > 11 && $productos[$i]["stockmetro"] <= 15){
