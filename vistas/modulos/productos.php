            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="nuevostockmetro" min="0" placeholder="stockmetro" required>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editarstockmetro" name="editarstockmetro" min="0" required>
