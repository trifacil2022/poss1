            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                foreach ($listaProducto as $key => $value) {
                  $cantidadestotales= $cantidadestotales+ $value["cantidad"];
                  $item = "id";
                  $valor = $value["id"];
                  $orden = "id";
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3 ingresoPrecio" style="padding-left:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevoCantidadproductos" name="nuevoPrecioProducto" value="'.  $cantidadestotales.'" readonly required>
